...
class PropertyListFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mPropertyArray.add(Property("1", "33 Cottonwood Crescent, Calamvale, Qld 4116", 773855, "Sean Johansson", "house1"))
        mPropertyArray.add(Property("2", "9 Westgate Place, The Gap, Qld 4061", 944603, "Gianni Carbone", "house2"))
        mPropertyArray.add(Property("3", "55 Kempster Street, Sandgate, Qld 4017", 849000, "Kristy Kelly", "house3"))
        mPropertyArray.add(Property("4", "6/70 Freeman Road, Durack, Qld 4077", 595218, "Sarah Bailey","house4"))
        mPropertyArray.add(Property("5", "12 Arrol Street, Camp Hill, Qld 4152", 1977972, "Roger Carr", "house5"))
        mPropertyArray.add(Property("6", "37 Kahli Place, Carseldine, Qld 4034", 970692, "Libby Patrick", "house6"))
